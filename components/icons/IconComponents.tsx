...
export const UsersIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-7.53-2.475M15 19.128v-3.86a2.25 2.25 0 0 1 3-1.732a2.25 2.25 0 0 1-2.25 2.25c-.832 0-1.612-.445-2.031-1.203a3.12 3.12 0 0 0-2.294 0 3.125 3.125 0 0 0-2.031 1.203 2.25 2.25 0 0 1-2.25-2.25 2.25 2.25 0 0 1 3 1.732V19.128a9.38 9.38 0 0 0-2.625.372 9.337 9.337 0 0 0-4.121-.952 4.125 4.125 0 0 0 7.53 2.475" />
...
export const MegaphoneIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6.375c-1.033.23-2.02.589-2.914 1.052M10.5 6.375a4.5 4.5 0 0 1 4.5 4.5m-4.5-4.5V3.75m0 2.625A4.5 4.5 0 0 0 6 10.875m4.5-4.5m0 0v2.625m0 0a4.5 4.5 0 0 1 4.5 4.5m-4.5-4.5a4.5 4.5 0 0 0-4.5 4.5m4.5-4.5m6.354 1.354 1.346 1.346a.75.75 0 0 1 0 1.06l-1.346 1.346a.75.75 0 0 1-1.06 0l-1.346-1.346a.75.75 0 0 1 0-1.06l1.346-1.346a.75.75 0 0 1 1.06 0Zm-9.192 0 1.346 1.346a.75.75 0 0 1 0 1.06l-1.346 1.346a.75.75 0 0 1-1.06 0L4.346 12.31a.75.75 0 0 1 0-1.06l1.346-1.346a.75.75 0 0 1 1.06 0Zm9.192 3.182a.75.75 0 0 0 0 1.061l1.346 1.346a.75.75 0 0 0 1.06 0l1.346-1.346a.75.75 0 0 0 0-1.061l-1.346-1.346a.75.75 0 0 0-1.06 0l-1.346 1.346ZM7.5 15.375a.75.75 0 0 0 0 1.061l1.346 1.346a.75.75 0 0 0 1.06 0l1.346-1.346a.75.75 0 0 0 0-1.061l-1.346-1.346a.75.75 0 0 0-1.06 0l-1.346 1.346Z" />
    </svg>
);

export const ChatBubbleLeftRightIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72 3.72a.75.75 0 0 1-1.06 0l-3.72-3.72a2.123 2.123 0 0 1-1.98-2.193v-4.286c0-.97.616-1.813 1.5-2.097m6.72-.636a.75.75 0 0 0-1.06 0l-1.06 1.06a.75.75 0 0 1-1.06 0l-1.06-1.06a.75.75 0 0 0-1.06 0l-1.06 1.06a.75.75 0 0 1-1.06 0l-1.06-1.06a.75.75 0 0 0-1.06 0l-3.182 3.182a.75.75 0 0 0 0 1.06l1.06 1.06a.75.75 0 0 1 0 1.06l-1.06 1.06a.75.75 0 0 0 0 1.06l3.182 3.182a.75.75 0 0 0 1.06 0l1.06-1.06a.75.75 0 0 1 1.06 0l1.06 1.06a.75.75 0 0 0 1.06 0l1.06-1.06a.75.75 0 0 1 1.06 0l1.06 1.06a.75.75 0 0 0 1.06 0l3.182-3.182a.75.75 0 0 0 0-1.06l-1.06-1.06a.75.75 0 0 1 0-1.06l1.06-1.06a.75.75 0 0 0 0-1.06l-3.182-3.182Z" />
    </svg>
);
...
export const ClipboardDocumentListIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 0 0 .75-.75 2.25 2.25 0 0 0-.1-.664m-5.8 0A2.251 2.251 0 0 1 13.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-1.125 0-2.062.938-1.976 2.062a48.458 48.458 0 0 0 .93 6.643A48.458 48.458 0 0 0 7.5 20.25l.25.25a2.25 2.25 0 0 0 3.182 0l.25-.25a48.46 48.46 0 0 0 2.186-2.613c.244-.29.458-.6-.65-.92m-5.8 0a2.251 2.251 0 0 1-2.15-1.586m5.8 0c.376.023.75.05 1.124.08" />
    </svg>
);
...
export const CalendarDaysIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 12.75h.008v.008H9.75v-.008Zm3 0h.008v.008H12.75v-.008Zm3 0h.008v.008H15.75v-.008Zm-6 2.25h.008v.008H9.75v-.008Zm3 0h.008v.008H12.75v-.008Zm3 0h.008v.008H15.75v-.008Z" />
    </svg>
);

export const ChartBarSquareIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
